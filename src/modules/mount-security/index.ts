 ...
 *
 * Allowlist location: `~/.config/nanoclaw/mount-allowlist.json` (path retained for
 * backward compatibility with existing installs; see `MOUNT_ALLOWLIST_PATH` in `src/config.ts`).
 */
import fs from 'fs';
import os from 'os';
